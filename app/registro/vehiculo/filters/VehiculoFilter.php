...
//                ->rule(["rule" => "required"])
            ->filter(["field" => "txt_cilindrada", "label" => $this->_frm->cilindrada])
                ->rule(["rule" => "required"])
            ->filter(["field" => "txt_serie", "label" => $this->_frm->nro_serie])
                ->rule(["rule" => "required"])
            ->filter(["field" => "txt_nromotor", "label" => $this->_frm->nro_motor])
                ->rule(["rule" => "required"])
            ->filter(["field" => "txt_modelo", "label" => $this->_frm->modelo])
                ->rule(["rule" => "required"])
            ->filter(["field" => "txt_marca", "label" => $this->_frm->marca])
                ->rule(["rule" => "required"])
            ->filter(["field" => "txt_placa", "label" => $this->_frm->placa])
                ->rule(["rule" => "required"])
