    ...
    <form>
        <div class="row">
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><span class="label label-default" id="sp_pendientes">0</span></td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <div class="col-md-8">
                ...
                <div class="jarviswidget jarviswidget-color-blueDark">
                    <header role="heading">
                        <span class="widget-icon"> <i class="fa fa-pie-chart txt-color-blueLight"></i> </span>		
                        <h2 class="tr-language" data-tr="grafico_pre_conversion"> </h2>
                    </header>
                    <!-- widget div-->
                    <div role="content">
                        <!-- widget edit box -->
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="jarviswidget jarviswidget-color-blueDark">
                    <header role="heading">
                        <span class="widget-icon"> <i class="fa fa-gears txt-color-blueLight"></i> </span>		
            ...
            <div class="col-md-8">
                ...
                <div class="jarviswidget jarviswidget-color-blueDark">
                    <header role="heading">
                        <span class="widget-icon"> <i class="fa fa-pie-chart txt-color-blueLight"></i> </span>		
                        <h2 class="tr-language" data-tr="grafico_conversion"> </h2>
                    </header>
                    <!-- widget div-->
                    <div role="content">
                        <!-- widget edit box -->
