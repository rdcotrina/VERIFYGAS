...
//    final protected function loadAssets() {
//        $e = new Exception();
//        $trace = $e->getTrace();
//        $last_call = $trace[1]; /* trae datos de clase donde se ejecuta parent::__construct(); -- de \Controller */
//
...
//        $controller = strtolower(array_shift($clase));
//
//        $ruta = ROOT . DEFAULT_APP_FOLDER . DS . $module . DS . $controller . DS . 'assets' . DS;
//
//        $this->_readDirectory($ruta);
//    }
